...
# Form implementation generated from reading ui file 'raspisanie.ui'
#
...
"border-radius: 5px;")
        ...
        self.AddLine.setGeometry(QtCore.QRect(150, 50, 131, 31))
...
"border-radius: 5px;")
        ...
        self.AddLine_1.setGeometry(QtCore.QRect(570, 50, 101, 31))
...
"border-radius: 5px;")
        ...
        self.AddLine_2.setGeometry(QtCore.QRect(300, 50, 101, 31))
...
"border-radius: 5px;")
        ...
        self.AddLine_3.setGeometry(QtCore.QRect(420, 50, 131, 31))
...
"border-radius: 5px;")
        ...
        self.ChangeLine_4.setGeometry(QtCore.QRect(530, 90, 131, 31))
...
"border-radius: 5px;")
        ...
        self.ChangeLine_1.setGeometry(QtCore.QRect(260, 90, 131, 31))
...
"border-radius: 5px;")
        ...
        self.ChangeLine_2.setGeometry(QtCore.QRect(680, 90, 101, 31))
...
"border-radius: 5px;")
        ...
        self.ChangeLine_3.setGeometry(QtCore.QRect(410, 90, 101, 31))
...
"border-radius: 5px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.AddLine.setPlaceholderText(_translate("MainWindow", "day of the week"))
        self.AddLine_1.setPlaceholderText(_translate("MainWindow", "end of work"))
        self.AddLine_2.setPlaceholderText(_translate("MainWindow", "doctor"))
        self.AddLine_3.setPlaceholderText(_translate("MainWindow", "getting started"))
        self.ChangeLine_4.setPlaceholderText(_translate("MainWindow", "getting started"))
        self.ChangeLine_1.setPlaceholderText(_translate("MainWindow", "day of the week"))
        self.ChangeLine_2.setPlaceholderText(_translate("MainWindow", "end of work"))
        self.ChangeLine_3.setPlaceholderText(_translate("MainWindow", "doctor"))
        self.ChangeLine.setPlaceholderText(_translate("MainWindow", "ID"))
