...
# Form implementation generated from reading ui file 'priem.ui'
#
...
"border-radius: 5px;")
        ...
        self.AddLine.setGeometry(QtCore.QRect(150, 50, 141, 31))
...
"border-radius: 5px;")
        ...
        self.AddLine_1.setGeometry(QtCore.QRect(310, 50, 121, 31))
...
"border-radius: 5px;")
        ...
        self.AddLine_2.setGeometry(QtCore.QRect(450, 50, 101, 31))
...
"border-radius: 5px;")
        ...
        self.AddLine_3.setGeometry(QtCore.QRect(570, 50, 101, 31))
...
"border-radius: 5px;")
        ...
        self.ChangeLine_4.setGeometry(QtCore.QRect(680, 90, 101, 31))
...
"border-radius: 5px;")
        ...
        self.ChangeLine_1.setGeometry(QtCore.QRect(260, 90, 141, 31))
...
"border-radius: 5px;")
        ...
        self.ChangeLine_2.setGeometry(QtCore.QRect(420, 90, 121, 31))
...
"border-radius: 5px;")
        ...
        self.ChangeLine_3.setGeometry(QtCore.QRect(560, 90, 101, 31))
...
"border-radius: 5px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.AddLine.setPlaceholderText(_translate("MainWindow", "date of admission"))
        self.AddLine_1.setPlaceholderText(_translate("MainWindow", "reception time"))
        self.AddLine_2.setPlaceholderText(_translate("MainWindow", "doctor"))
        self.AddLine_3.setPlaceholderText(_translate("MainWindow", "patient"))
        self.ChangeLine_4.setPlaceholderText(_translate("MainWindow", "pacient"))
        self.ChangeLine_1.setPlaceholderText(_translate("MainWindow", "date of admission"))
        self.ChangeLine_2.setPlaceholderText(_translate("MainWindow", "reception time"))
